...
class GenerarScoreboard extends React.Component {
  ...
  generarReporte = async () => {
    ...
    const tmpIDs = this.state.problemas.map((problema) => problema.idProblema);
        ...
        <tr>
          ...
          <td>
            <button
              ...
              onClick={() => this.eliminarProblema(problema.idProblema)}
            >
              Eliminar
            </button>
          </td>
          ...
          <form class="row g-3">
            <div class="col-md-6">
              ...
              <input
                ...
                onChange={(event) => this.setState({ ids: event.target.value })}
              />
            </div>
          </form>
          <button
