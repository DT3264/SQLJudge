        ...
        <tr>
          ...
          <td>
            <button
              ...
              onClick={() =>
                this.handleOpenEliminar(problema.idProblema, problema.nombre)
              }
            >
              Eliminar
            </button>
            <button
              ...
              onClick={() =>
                this.props.history.push("/actualizar-problema", {
                  problema1: {
                    idProblema: problema.id,
                    nombre: problema.nombre,
                    descripcion: problema.descripcion,
                    solucion: problema.solucion,
                    idBaseDeDatos: problema.baseDatos.idBase,
                    idCategoria: problema.categoria.idCategoria,
