      ...
      <div>
        <form className="row g-3">
          <div className="col-md-6">
            <label className="form-label">Titulo del Problema</label>
            <input
              name="titulo"
          ...
          <div className="col-md-12">
            <label className="form-label">Código de la solución</label>
          ...
          <div className="col-md-12">
            ...
            <label className="form-label">
              <a href="https://localhost:5001/redaccion" target="_blank">
          ...
          <div className="col-md-12">
            <div class="form-check">
              <input
                ...
                onChange={() =>
                  this.setState({
                    comprobarOrdenFilas: !this.state.comprobarOrdenFilas,
                  })
                }
              />
