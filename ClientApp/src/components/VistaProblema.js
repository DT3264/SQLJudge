      ...
      <div>
        ...
        <div>
          <p style={{ textAlign: "center" }}>
            {" "}
            <b>ID:</b> {this.state.id} <b>Categoria:</b> {this.state.categoria}{" "}
            <b>Base de datos:</b> {this.state.baseDatos} <b>No. Resueltos:</b>{" "}
            {this.state.resueltos} <br />
          </p>
        </div>
        <button
          type="button"
        ...
        <div style={{ marginTop: "2rem" }}>
          <div class="col-md-12">
            <ReactMarkdown children={this.state.descripcion} />
          </div>
        </div>
        <div>
        ...
        <div style={{ marginTop: "2rem" }}>
          <button
            ...
            onClick={() =>
              this.sendSolution(this.state.id, this.state.codigoFuente)
            }
          >
            Enviar
          </button>
