      ...
      loginSection = (
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item" to="/fetch-data">
                  Ver perfil
                </Link>
              </li>
              <li>
      ...
      listOfLinks = (
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item" to="/lista-usuarios">
                  Ver Usuarios
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/lista-alumnos">
                  Ver alumnos
                </Link>
              </li>
            </ul>
          ...
          <li className="nav-item dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item" to="/lista-problemas">
                  Ver problemas
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/crear-problema">
                  Crear Problema
                </Link>
              </li>
            </ul>
